...
A daily GitHub Actions job that files newly liked YouTube Music tracks into a private monthly playlist (for example, `July '26 - Liked Songs`), so you get a personal mixtape each month without manual upkeep.
